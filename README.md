...
- Csináljatok egy "adatok.txt" fájlt, amiben töltsétek ki a neveteket, szakotokat és Neptun kódotokat, valamint az évfolyam típusát (nappali vagy távoktatás).
...
- Objektum orientált elemekkel készítsétek el
- Ahol lehet használjatok non-public attribútumokat
- Használjatok gettereket és settereket
- Használjatok dunder metódusokat
- A tanultak alapján legyen benne hibakezelés (pl típusokra, dátumokra) 
